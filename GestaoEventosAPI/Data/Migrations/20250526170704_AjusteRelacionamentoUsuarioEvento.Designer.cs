...
namespace GestaoEventosAPI.Data.Migrations
{
    ...
    [Migration("20250526170704_AjusteRelacionamentoUsuarioEvento")]
    partial class AjusteRelacionamentoUsuarioEvento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestaoEventosAPI.Domain.Entities.Usuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("GestaoEventosAPI.Domain.Entities.Organizador", b =>
                {
                    b.HasOne("GestaoEventosAPI.Domain.Entities.Usuario", "Usuario")
                        .WithMany()
